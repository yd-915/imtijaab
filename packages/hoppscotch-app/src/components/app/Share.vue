...
const text = "Imtijaab - Open source API development ecosystem & marketplace."
const description = "Build, Test and Monetize your APIs all in one platform."
const subject = "Check it out - an open source API development ecosystem"
const summary = `Hi there!%0D%0A%0D%0AI thought you'll like this new platform that I joined called Imtijaab - https://hoppscotch.io.%0D%0AIt is a simple and intuitive interface for creating and managing your APIs. You can build, test, document, and share your APIs.%0D%0A%0D%0AThe best part about Hoppscotch is that it is open source and free to get started.%0D%0A%0D%0A`
