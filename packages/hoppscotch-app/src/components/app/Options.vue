...
const nativeShare = () => {
  if (navigator.share) {
    navigator
      .share({
        title: "Imtijaab",
        text: "Imtijaab • Open source API development ecosystem & marketplace - Helps you make requests faster, saving precious time on development and monetize it. All in one place!",
